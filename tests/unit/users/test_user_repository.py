...
class TestUserRepository:
    ...
    def test_list_users_filter_by_is_active(self, session: Session, test_user: User, test_inactive_user: User):
    ...
    def test_list_users_filter_by_is_superuser(self, session: Session, test_superuser: User):
    ...
    def test_list_users_filter_by_is_staff(self, session: Session, test_superuser: User):
